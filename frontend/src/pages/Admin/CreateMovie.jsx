...
const CreateMovie = () => {
    ...
    const {data: genres, isLoading: isLoadingGenres} = useListGenresGenresQuery();
        ...
        <form>
            ...
            <div className="mb-4">
                <label className="block">
                    ...
                    <input type="text" name="cast" value={movieData.cast.join(", ")} onChange={(e) => setMovieData({...movieData, cast: e.target.value.split(", ")})} 
            ...
            <div className="mb-4">
                <label style={!selectedImage ? {border: "1px solid #888", 
