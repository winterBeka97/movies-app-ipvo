...
const Register = () => {
   ...
   <div className="pl-[10rem] flex flex-wrap">
    ...
    <form onSubmit={submitHandler} className='container w-[40rem]'>
        ...
        <div className="my-[2rem]">
            ...
            <input type="password" id="confirmPassword" className='mt-1 p-2 border rounded w-full'
             placeholder='Renter password' value={confirmPassword} onChange={(e)=>setConfirmPassword(e.target.value)} />
        </div>
        <button disabled={isLoading} type="submit" className="bg-teal-500 text-white px-4 py-2 rounded cursos-pointer my-[1rem]">
    ...
    <img src="https://images.unsplash.com/photo-1513106580091-1d82408b8cd6?q=80&w=1176&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
      alt="cinema-photo" className="h-[42rem] w-[45.5%] xl:block md:hidden sm hidden rounded-lg"/>
   </div>);
};
